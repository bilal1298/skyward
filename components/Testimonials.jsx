                ...
                <div className={classes.images}>
                  <Swiper className="testimonialSwiper" style={{ padding: "50px" }} modules={[Navigation]} spaceBetween={50} slidesPerView={3} navigation>
                    <SwiperSlide>
                      <div>
                        <Image
                          className={`${currentTestimonial === 0 ? classes.active : undefined}`}
                    ...
                    <SwiperSlide>
                      <div>
                        <Image
                          className={`${currentTestimonial === 1 ? classes.active : undefined}`}
                    ...
                    <SwiperSlide>
                      <div>
                        <Image
                          className={`${currentTestimonial === 2 ? classes.active : undefined}`}
                    ...
                    <SwiperSlide>
                      <div>
                        <Image
                          className={`${currentTestimonial === 3 ? classes.active : undefined}`}
